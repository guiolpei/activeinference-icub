...
extern bool publish;
extern BufferedPort<Bottle> plot_q1, plot_q2, plot_q3;
extern BufferedPort<Bottle> plot_mu1, plot_mu2, plot_mu3;
extern BufferedPort<Bottle> plot_a1, plot_a2, plot_a3;
extern BufferedPort<Bottle> plot_u, plot_v;
extern BufferedPort<Bottle> plot_calc_u, plot_calc_v;
extern BufferedPort<Bottle> plot_q1e, plot_q2e;
extern BufferedPort<Bottle> plot_mu1e, plot_mu2e;
extern BufferedPort<Bottle> plot_mu1ep, plot_mu2ep;
extern BufferedPort<Bottle> plot_a1e, plot_a2e;
extern BufferedPort<Bottle> plot_q1b, plot_q2b, plot_q3b;
extern BufferedPort<Bottle> plot_mu1b, plot_mu2b, plot_mu3b;
extern BufferedPort<Bottle> plot_mu1bp, plot_mu2bp, plot_mu3bp;
extern BufferedPort<Bottle> plot_a1b, plot_a2b, plot_a3b;
...
extern yarp::sig::Vector re_pos; //right arm left eye position
extern yarp::sig::Vector le_pos; //left arm left eye position
extern yarp::sig::Vector calc_vision_pos; //right arm calculated position in visual field
...
extern Vector4d d1_le_projection; //head derivative wrt mu1
extern Vector4d d2_le_projection; //head derivative wrt mu2
...
//Vision ---------------------------------------------------------------------------
//Left eye
void calc_le_rototranslational_matrix();
void calc_le_rototranslational_matrix_h();
void calc_le_rototranslational_matrix_b();
