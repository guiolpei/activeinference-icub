...
double read_encoders_q1(vector<double> mu, vector<double> a)
{
	...
	if (publish)
	{
		...
		output_q1.clear();
		output_q1.addDouble(CTRL_RAD2DEG*qRAencoders[1]);
		plot_q1.write();
	}
...
double read_encoders_q2(vector<double> mu, vector<double> a)
{
	...
	if (publish)
	{
		...
		output_q2.clear();
		output_q2.addDouble(CTRL_RAD2DEG*qRAencoders[2]);
		plot_q2.write();
	}	
...
double read_encoders_q3(vector<double> mu, vector<double> a)
{
	...
	if (publish)
	{
		...
		output_q3.clear();
		output_q3.addDouble(CTRL_RAD2DEG*qRAencoders[3]);
		plot_q3.write();
	}	
...
{
	//read only on first
	//qRAendpos = iCubRightArmKin->getEndEffectorPosition();
	yarp::sig::Matrix qRAH = iCubRightArmKin->getH();
	Vector qRArE;
	
	qRArE.resize(4);
	qRArE[0] = xh/k; qRArE[1] = yh/k; qRArE[2] = zh/k; qRArE[3] = 1;
		
	qRAendpos = qRAH*qRArE;
...
double sense_3d_position_x_b(vector<double> mu, vector<double> a)
{
    //read only on first
    //qRAendpos = iCubRightArmKin->getEndEffectorPosition();
    yarp::sig::Matrix qLAH = iCubLeftArmKin->getH();
    Vector qLArE;

    qLArE.resize(4);
    qLArE[0] = xhb/k; qLArE[1] = yhb/k; qLArE[2] = zhb/k; qLArE[3] = 1;

    qLAendpos = qLAH*qLArE;
...
double read_encoders_q1b(vector<double> mu, vector<double> a)
{
    ...
    if (publish)
    {
        ...
        output_q1b.clear();
        output_q1b.addDouble(CTRL_RAD2DEG*qLAencoders[1]);
        plot_q1b.write();
    }
...
double read_encoders_q2b(vector<double> mu, vector<double> a)
{
    ...
    if (publish)
    {
        ...
        output_q2b.clear();
        output_q2b.addDouble(CTRL_RAD2DEG*qLAencoders[2]);
        plot_q2b.write();
    }
...
double read_encoders_q3b(vector<double> mu, vector<double> a)
{
    ...
    if (publish)
    {
        ...
        output_q3b.clear();
        output_q3b.addDouble(CTRL_RAD2DEG*qLAencoders[3]);
        plot_q3b.write();
    }
...
void calc_d_3d_rototranslational_matrix_mu1(vector<double> mu, vector<double> a)
{
	...
	//H11d1
	ra_d1rtm(0,0) = Sin(q10)*(Cos(q8)*(Cos(q5)*(-(Cos(q1)*Cos(q3)) - 
           Cos(q2)*Sin(q1)*Sin(q3)) - 
        (Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
	...
	//H21d1
	ra_d1rtm(1,0) = Sin(q10)*(Cos(q8)*(-(Cos(q5)*Sin(q2)*Sin(q3)) - 
  ...
  Cos(q10)*(Cos(q9)*(Cos(q8)*(Cos(q6)*Cos(q7)*
	...
	//H31d1
	ra_d1rtm(2,0) = Sin(q10)*(Cos(q8)*(Cos(q5)*(-(Cos(q3)*Sin(q1)) + 
           Cos(q1)*Cos(q2)*Sin(q3)) - 
        (Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
	...
	//H12d1
	ra_d1rtm(0,1) = Cos(q10)*(Cos(q8)*(Cos(q5)*(-(Cos(q1)*Cos(q3)) - 
           Cos(q2)*Sin(q1)*Sin(q3)) - 
        (Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
           Sin(q1)*Sin(q2)*Sin(q4))*Sin(q5))*Sin(q6) + 
     (Cos(q6)*Cos(q7)*(Cos(q5)*
	...
	//H22d1
	ra_d1rtm(1,1) = Cos(q10)*(Cos(q8)*(-(Cos(q5)*Sin(q2)*Sin(q3)) - 
        (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))*Sin(q5))*Sin(q6) + 
     (Cos(q6)*Cos(q7)*(-(Cos(q5)*Sin(q2)*Sin(q3)) - 
           (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))*Sin(q5)) + 
        (Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
  ...
  Sin(q10)*(Cos(q9)*(Cos(q8)*(Cos(q6)*Cos(q7)*
	...
	//H32d1
	ra_d1rtm(2,1) = Cos(q10)*(Cos(q8)*(Cos(q5)*(-(Cos(q3)*Sin(q1)) + 
           Cos(q1)*Cos(q2)*Sin(q3)) - 
        (Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
           Cos(q1)*Sin(q2)*Sin(q4))*Sin(q5))*Sin(q6) + 
     (Cos(q6)*Cos(q7)*(Cos(q5)*
...
- (Cos(q5)*(-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3)) - 
	...
	//H23d1
	ra_d1rtm(1,2) = -(Cos(q9)*(-(Cos(q7)*(Cos(q5)*
             (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
            Sin(q2)*Sin(q3)*Sin(q5))) + 
       Cos(q6)*(-(Cos(q5)*Sin(q2)*Sin(q3)) - 
          (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))*Sin(q5))*Sin(q7))) \
...
- (Cos(q5)*(-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3)) - 
	...
	//H14d1
	ra_d1rtm(0,3) = d6*(-(Cos(q5)*(Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
          Sin(q1)*Sin(q2)*Sin(q4))) - 
     (-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))*Sin(q5)) + 
  ...
  d10*(-(Cos(q9)*(-(Cos(q7)*(Cos(q5)*
	...
	//H24d1
	ra_d1rtm(1,3) = d6*(-(Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))) + 
     Sin(q2)*Sin(q3)*Sin(q5)) + 
  ...
  a10*Cos(q10)*(Cos(q9)*(Cos(q8)*
	...
	//H34d1
	ra_d1rtm(2,3) = d6*(-(Cos(q5)*(Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
          Cos(q1)*Sin(q2)*Sin(q4))) - 
     (-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))*Sin(q5)) + 
...
void calc_d_3d_rototranslational_matrix_mu2(vector<double> mu, vector<double> a)
{
	...
	//H11d3
	ra_d2rtm(0,0) = Sin(q10)*(-(Cos(q8)*(-(Cos(q6)*
             (Cos(q5)*(Cos(q4)*
                   (-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
                  Sin(q1)*Sin(q2)*Sin(q4)) + 
               (-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))*Sin(q5))) - 
	...
	//H21d3
	ra_d2rtm(1,0) = Sin(q10)*(-(Cos(q8)*(-(Cos(q6)*
             (Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
               Sin(q2)*Sin(q3)*Sin(q5))) - 
          (Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4))*Sin(q6))) + 
  ...
  Cos(q10)*(Cos(q9)*(Cos(q7)*Cos(q8)*
	...
	//H31d3
	ra_d2rtm(2,0) = Sin(q10)*(-(Cos(q8)*(-(Cos(q6)*
             (Cos(q5)*(Cos(q4)*
                   (Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
                  Cos(q1)*Sin(q2)*Sin(q4)) + 
               (-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))*Sin(q5))) - 
...
+ Cos(q7)*(Cos(q6)*(Cos(q1)*Cos(q4)*Sin(q2) - 
	...
	//H12d3
	ra_d2rtm(0,1) = Cos(q10)*(-(Cos(q8)*(-(Cos(q6)*
             (Cos(q5)*(Cos(q4)*
                   (-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
                  Sin(q1)*Sin(q2)*Sin(q4)) + 
               (-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))*Sin(q5))) - 
	...
	//H22d3
	ra_d2rtm(1,1) = Cos(q10)*(-(Cos(q8)*(-(Cos(q6)*
             (Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
               Sin(q2)*Sin(q3)*Sin(q5))) - 
          (Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4))*Sin(q6))) + 
     Cos(q7)*(Cos(q6)*(Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4)) - 
  ...
  Sin(q10)*(Cos(q9)*(Cos(q7)*Cos(q8)*
	...
	//H32d3
	ra_d2rtm(2,1) = Cos(q10)*(-(Cos(q8)*(-(Cos(q6)*
             (Cos(q5)*(Cos(q4)*
                   (Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
                  Cos(q1)*Sin(q2)*Sin(q4)) + 
               (-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))*Sin(q5))) - 
...
+ Cos(q7)*(Cos(q6)*(Cos(q1)*Cos(q4)*Sin(q2) - 
	...
	//H13d3
	ra_d2rtm(0,2) = -(Cos(q9)*(Cos(q6)*(-(Cos(q4)*Sin(q1)*Sin(q2)) - 
          (-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3))*Sin(q4)) - 
       (Cos(q5)*(Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + 
                Cos(q1)*Sin(q3)) - Sin(q1)*Sin(q2)*Sin(q4)) + 
          (-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))*Sin(q5))*Sin(q6))*
...
+ (-(Cos(q6)*(Cos(q5)*(Cos(q4)*
	...
	//H23d3
	ra_d2rtm(1,2) = -(Cos(q9)*(Cos(q6)*(Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4)) - 
       (Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
  ...
  (Cos(q7)*Cos(q8)*(Cos(q6)*(Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4)) - 
	...
	//H33d3
	ra_d2rtm(2,2) = -(Cos(q9)*(Cos(q6)*(Cos(q1)*Cos(q4)*Sin(q2) - 
          (Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3))*Sin(q4)) - 
       (Cos(q5)*(Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
             Cos(q1)*Sin(q2)*Sin(q4)) + 
          (-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))*Sin(q5))*Sin(q6))*
...
+ (-(Cos(q6)*(Cos(q5)*(Cos(q4)*
	...
	//H14d3
	ra_d2rtm(0,3) = a6*Cos(q6)*(-(Cos(q4)*Sin(q1)*Sin(q2)) - 
     (-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3))*Sin(q4)) - 
...
- (-(Cos(q4)*Sin(q1)*Sin(q2)) - 
	...
	//H24d3
	ra_d2rtm(1,3) = a6*Cos(q6)*(Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4)) - 
  ...
  d10*(-(Cos(q9)*(Cos(q6)*(Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4)) - 
	...
	//H34d3
	ra_d2rtm(2,3) = a6*Cos(q6)*(Cos(q1)*Cos(q4)*Sin(q2) - 
     (Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3))*Sin(q4)) - 
...
void calc_d_3d_rototranslational_matrix_mu3(vector<double> mu, vector<double> a)
{
	...
	//H11d2
	ra_d3rtm(0,0) = Sin(q10)*(Cos(q7)*(-(Cos(q5)*(-(Cos(q1)*Cos(q3)) - 
             Cos(q2)*Sin(q1)*Sin(q3))) + 
        (Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
           Sin(q1)*Sin(q2)*Sin(q4))*Sin(q5)) - 
     (Cos(q6)*(Cos(q5)*(Cos(q4)*
	...
	//H21d2
	ra_d3rtm(1,0) = Sin(q10)*(Cos(q7)*(Cos(q5)*Sin(q2)*Sin(q3) + 
        (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))*Sin(q5)) - 
     (Cos(q6)*(Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
           Sin(q2)*Sin(q3)*Sin(q5)) + 
        (Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4))*Sin(q6))*Sin(q7))*
   Sin(q8) + Cos(q10)*(Cos(q8)*Cos(q9)*
	...
	//H31d2
	ra_d3rtm(2,0) = Sin(q10)*(Cos(q7)*(-(Cos(q5)*(-(Cos(q3)*Sin(q1)) + 
             Cos(q1)*Cos(q2)*Sin(q3))) + 
        (Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
           Cos(q1)*Sin(q2)*Sin(q4))*Sin(q5)) - 
     (Cos(q6)*(Cos(q5)*(Cos(q4)*
...
+ (-(Cos(q5)*(-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))) + 
	...
	//H12d2
	ra_d3rtm(0,1) = Cos(q10)*(Cos(q7)*(-(Cos(q5)*(-(Cos(q1)*Cos(q3)) - 
             Cos(q2)*Sin(q1)*Sin(q3))) + 
        (Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
           Sin(q1)*Sin(q2)*Sin(q4))*Sin(q5)) - 
     (Cos(q6)*(Cos(q5)*(Cos(q4)*
	...
	//H22d2
	ra_d3rtm(1,1) = Cos(q10)*(Cos(q7)*(Cos(q5)*Sin(q2)*Sin(q3) + 
        (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))*Sin(q5)) - 
     (Cos(q6)*(Cos(q5)*(-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
           Sin(q2)*Sin(q3)*Sin(q5)) + 
        (Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4))*Sin(q6))*Sin(q7))*
   Sin(q8) - Sin(q10)*(Cos(q8)*Cos(q9)*
	...
	//H32d2
	ra_d3rtm(2,1) = Cos(q10)*(Cos(q7)*(-(Cos(q5)*(-(Cos(q3)*Sin(q1)) + 
             Cos(q1)*Cos(q2)*Sin(q3))) + 
        (Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
           Cos(q1)*Sin(q2)*Sin(q4))*Sin(q5)) - 
     (Cos(q6)*(Cos(q5)*(Cos(q4)*
...
+ (-(Cos(q5)*(-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))) + 
	...
	//H13d2
	ra_d3rtm(0,2) = -(Cos(q9)*(Cos(q7)*(Cos(q6)*(Cos(q5)*
              (Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
                Sin(q1)*Sin(q2)*Sin(q4)) + 
             (-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))*Sin(q5)) + 
          (-(Cos(q4)*Sin(q1)*Sin(q2)) - 
  ...
  Cos(q8)*(Cos(q7)*(-(Cos(q5)*
	...
	//H23d2
	ra_d3rtm(1,2) = -(Cos(q9)*(Cos(q7)*(Cos(q6)*(Cos(q5)*
              (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4)) - 
             Sin(q2)*Sin(q3)*Sin(q5)) + 
          (Cos(q2)*Cos(q4) + Cos(q3)*Sin(q2)*Sin(q4))*Sin(q6)) + 
       (Cos(q5)*Sin(q2)*Sin(q3) + 
...
+ Cos(q8)*(Cos(q7)*(Cos(q5)*Sin(q2)*Sin(q3) + 
	...
	//H33d2
	ra_d3rtm(2,2) = -(Cos(q9)*(Cos(q7)*(Cos(q6)*(Cos(q5)*
              (Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
                Cos(q1)*Sin(q2)*Sin(q4)) + 
             (-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))*Sin(q5)) + 
          (Cos(q1)*Cos(q4)*Sin(q2) - 
...
+ (-(Cos(q5)*(-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))) + 
  ...
  Cos(q8)*(Cos(q7)*(-(Cos(q5)*
	...
	//H14d2
	ra_d3rtm(0,3) = a7*Cos(q7)*(-(Cos(q5)*(-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))) + 
     (Cos(q4)*(-(Cos(q2)*Cos(q3)*Sin(q1)) + Cos(q1)*Sin(q3)) - 
        Sin(q1)*Sin(q2)*Sin(q4))*Sin(q5)) - 
...
+ (-(Cos(q5)*(-(Cos(q1)*Cos(q3)) - Cos(q2)*Sin(q1)*Sin(q3))) + 
  ...
  d10*(-(Cos(q9)*(Cos(q7)*(Cos(q6)*
	...
	//H24d2
	ra_d3rtm(1,3) = a7*Cos(q7)*(Cos(q5)*Sin(q2)*Sin(q3) + 
     (-(Cos(q3)*Cos(q4)*Sin(q2)) + Cos(q2)*Sin(q4))*Sin(q5)) - 
  ...
  a10*Sin(q10)*(Cos(q7)*(Cos(q5)*Sin(q2)*Sin(q3) + 
   ...
   Sin(q8) + a10*Cos(q10)*(Cos(q8)*Cos(q9)*
	...
	//H34d2
	ra_d3rtm(2,3) = a7*Cos(q7)*(-(Cos(q5)*(-(Cos(q3)*Sin(q1)) + Cos(q1)*Cos(q2)*Sin(q3))) + 
     (Cos(q4)*(Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
        Cos(q1)*Sin(q2)*Sin(q4))*Sin(q5)) - 
  a7*(Cos(q6)*(Cos(q5)*(Cos(q4)*
            (Cos(q1)*Cos(q2)*Cos(q3) + Sin(q1)*Sin(q3)) + 
...
void calc_3d_rototranslational_matrix_b(vector<double> mu, vector<double> a)
{
    ...
    double q3b = la_q3b + la_q3;
    double q4b = la_q4b + la_q4;
    double q5b = la_q5b + mu[0]; //l_shoulder_roll
    double q6b = la_q6b + mu[1]; //l_shoulder_yaw
    double q7b = la_q7b + mu[2]; //l_elbow
...
void calc_d_3d_rototranslational_matrix_mu1b(vector<double> mu, vector<double> a)
{
    ...
    //H11d1b
    la_d1rtm(0,0) = Sin(q10b)*(Cos(q8b)*(Cos(q5b)*
             (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b)) -
            (Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
    ...
    //H21d1b
    la_d1rtm(1,0) = Sin(q10b)*(Cos(q8b)*(-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
             (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b))*
    ...
    //H31d1b
    la_d1rtm(2,0) = Sin(q10b)*(Cos(q8b)*(Cos(q5b)*
             (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b)) -
            (Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
    ...
    //H12d1b
    la_d1rtm(0,1) = Cos(q10b)*(Cos(q8b)*(Cos(q5b)*
                 (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b)) -
                (Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
                   Sin(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b))*Sin(q6b) +
             (Cos(q6b)*Cos(q7b)*(Cos(q5b)*
    ...
    //H22d1b
    la_d1rtm(1,1) = Cos(q10b)*(Cos(q8b)*(-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
             (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b))*
           Sin(q6b) + (Cos(q6b)*Cos(q7b)*
              (-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
                (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b)) +
    ...
    //H32d1b
    la_d1rtm(2,1) = Cos(q10b)*(Cos(q8b)*(Cos(q5b)*
             (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b)) -
            (Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
               Cos(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b))*Sin(q6b) +
         (Cos(q6b)*Cos(q7b)*(Cos(q5b)*
   ...
   + Cos(q6b)*(Cos(q5b)*(-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b)) -
    ...
    //H23d1b
    la_d1rtm(1,2) = -(Cos(q9b)*(-(Cos(q7b)*(-(Cos(q5b)*
                  (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))) +
               Sin(q2b)*Sin(q3b)*Sin(q5b))) +
          Cos(q6b)*(-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
             (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b))*
   ...
   + Cos(q6b)*(Cos(q5b)*(-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b)) -
    ...
    //H14d1b
    la_d1rtm(0,3) = d6b*(Cos(q5b)*(Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) +
                 Cos(q1b)*Sin(q3b)) + Sin(q1b)*Sin(q2b)*Sin(q4b)) +
           (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b))*Sin(q5b)) +
    ...
    //H24d1b
    la_d1rtm(1,3) = d6b*(Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b)) -
             Sin(q2b)*Sin(q3b)*Sin(q5b)) +
    ...
    //H34d1b
    la_d1rtm(2,3) = d6b*(Cos(q5b)*(Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
               Cos(q1b)*Sin(q2b)*Sin(q4b)) +
            (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b))*Sin(q5b)) +
...
void calc_d_3d_rototranslational_matrix_mu2b(vector<double> mu, vector<double> a)
{
    ...
    //H11d3b
    la_d2rtm(0,0) = Sin(q10b)*(-(Cos(q8b)*(-(Cos(q6b)*
                 (Cos(q5b)*(Cos(q4b)*
                       (-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
                      Sin(q1b)*Sin(q2b)*Sin(q4b)) +
                   (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b))*
    ...
    //H21d3b
    la_d2rtm(1,0) = Sin(q10b)*(-(Cos(q8b)*(-(Cos(q6b)*
                 (Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) -
                      Cos(q2b)*Sin(q4b)) - Sin(q2b)*Sin(q3b)*Sin(q5b))) -
              (-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b))*Sin(q6b))) +
    ...
    //H31d3b
    la_d2rtm(2,0) = Sin(q10b)*(-(Cos(q8b)*(-(Cos(q6b)*
                 (Cos(q5b)*(Cos(q4b)*
                       (Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
                      Cos(q1b)*Sin(q2b)*Sin(q4b)) +
                   (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b))*
    ...
    //H12d3b
    la_d2rtm(0,1) = Cos(q10b)*(-(Cos(q8b)*(-(Cos(q6b)*
                 (Cos(q5b)*(Cos(q4b)*
                       (-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
                      Sin(q1b)*Sin(q2b)*Sin(q4b)) +
                   (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b))*
    ...
    //H22d3b
    la_d2rtm(1,1) = Cos(q10b)*(-(Cos(q8b)*(-(Cos(q6b)*
                 (Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) -
                      Cos(q2b)*Sin(q4b)) - Sin(q2b)*Sin(q3b)*Sin(q5b))) -
              (-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b))*Sin(q6b))) +
         Cos(q7b)*(Cos(q6b)*(-(Cos(q2b)*Cos(q4b)) +
    ...
    //H32d3b
    la_d2rtm(2,1) = Cos(q10b)*(-(Cos(q8b)*(-(Cos(q6b)*
                 (Cos(q5b)*(Cos(q4b)*
                       (Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
                      Cos(q1b)*Sin(q2b)*Sin(q4b)) +
                   (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b))*
    ...
    //H13d3b
    la_d2rtm(0,2) = -(Cos(q9b)*(Cos(q6b)*(Cos(q4b)*Sin(q1b)*Sin(q2b) -
              (-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b))*Sin(q4b)) -
           (Cos(q5b)*(Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) +
                    Cos(q1b)*Sin(q3b)) + Sin(q1b)*Sin(q2b)*Sin(q4b)) +
              (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b))*Sin(q5b))*
    ...
    //H23d3b
    la_d2rtm(1,2) = -(Cos(q9b)*(Cos(q6b)*(-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b)) -
            (Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b)) -
    ...
    //H33d3b
    la_d2rtm(2,2) = -(Cos(q9b)*(Cos(q6b)*(-(Cos(q1b)*Cos(q4b)*Sin(q2b)) -
              (Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b))*Sin(q4b)) -
           (Cos(q5b)*(Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) +
                    Sin(q1b)*Sin(q3b)) - Cos(q1b)*Sin(q2b)*Sin(q4b)) +
              (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b))*Sin(q5b))*
    ...
    //H14d3b
    la_d2rtm(0,3) = a6b*Cos(q6b)*(Cos(q4b)*Sin(q1b)*Sin(q2b) -
              (-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b))*Sin(q4b)) -
    ...
    //H24d3b
    la_d2rtm(1,3) = a6b*Cos(q6b)*(-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b)) -
    ...
    //H34d3b
    la_d2rtm(2,3) = a6b*Cos(q6b)*(-(Cos(q1b)*Cos(q4b)*Sin(q2b)) -
              (Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b))*Sin(q4b)) -
...
void calc_d_3d_rototranslational_matrix_mu3b(vector<double> mu, vector<double> a)
{
    ...
    //H11d2b
    la_d3rtm(0,0) = Sin(q10b)*(Cos(q7b)*(Cos(q5b)*
             (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b)) -
            (Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
               Sin(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b)) -
         (Cos(q6b)*(Cos(q5b)*(Cos(q4b)*
    ...
    //H21d2
    la_d3rtm(1,0) = Sin(q10b)*(Cos(q7b)*(-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
         (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b)) -
      (Cos(q6b)*(Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) -
               Cos(q2b)*Sin(q4b)) - Sin(q2b)*Sin(q3b)*Sin(q5b)) +
         (-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b))*Sin(q6b))*
    ...
    //H31d2
    la_d3rtm(2,0) = Sin(q10b)*(Cos(q7b)*(Cos(q5b)*
             (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b)) -
            (Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
               Cos(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b)) -
         (Cos(q6b)*(Cos(q5b)*(Cos(q4b)*
    ...
    //H12d2
    la_d3rtm(0,1) = Cos(q10b)*(Cos(q7b)*(Cos(q5b)*
             (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b)) -
            (Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
               Sin(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b)) -
         (Cos(q6b)*(Cos(q5b)*(Cos(q4b)*
    ...
    //H22d2
    la_d3rtm(1,1) = Cos(q10b)*(Cos(q7b)*(-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
         (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b)) -
      (Cos(q6b)*(Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) -
               Cos(q2b)*Sin(q4b)) - Sin(q2b)*Sin(q3b)*Sin(q5b)) +
         (-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b))*Sin(q6b))*
    ...
    //H32d2
    la_d3rtm(2,1) = Cos(q10b)*(Cos(q7b)*(Cos(q5b)*
             (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b)) -
            (Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
               Cos(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b)) -
         (Cos(q6b)*(Cos(q5b)*(Cos(q4b)*
    ...
    //H13d2
    la_d3rtm(0,2) = -(Cos(q9b)*(Cos(q7b)*(Cos(q6b)*
                  (Cos(q5b)*(Cos(q4b)*
                        (-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
                       Sin(q1b)*Sin(q2b)*Sin(q4b)) +
                    (-(Cos(q1b)*Cos(q3b)) - Cos(q2b)*Sin(q1b)*Sin(q3b))*Sin(q5b)) \
    ...
    //H23d2
    la_d3rtm(1,2) = -(Cos(q9b)*(Cos(q7b)*(Cos(q6b)*
          (Cos(q5b)*(-(Cos(q3b)*Cos(q4b)*Sin(q2b)) -
               Cos(q2b)*Sin(q4b)) - Sin(q2b)*Sin(q3b)*Sin(q5b)) +
         (-(Cos(q2b)*Cos(q4b)) + Cos(q3b)*Sin(q2b)*Sin(q4b))*Sin(q6b)) +
      (-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
    ...
    //H33d2
    la_d3rtm(2,2) = -(Cos(q9b)*(Cos(q7b)*(Cos(q6b)*
                  (Cos(q5b)*(Cos(q4b)*
                        (Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
                       Cos(q1b)*Sin(q2b)*Sin(q4b)) +
                    (-(Cos(q3b)*Sin(q1b)) + Cos(q1b)*Cos(q2b)*Sin(q3b))*Sin(q5b)) \
    ...
    //H14d2
    la_d3rtm(0,3) = a7b*Cos(q7b)*(Cos(q5b)*(-(Cos(q1b)*Cos(q3b)) -
                Cos(q2b)*Sin(q1b)*Sin(q3b)) -
             (Cos(q4b)*(-(Cos(q2b)*Cos(q3b)*Sin(q1b)) + Cos(q1b)*Sin(q3b)) +
                Sin(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b)) -
    ...
    //H24d2
    la_d3rtm(1,3) = a7b*Cos(q7b)*(-(Cos(q5b)*Sin(q2b)*Sin(q3b)) -
              (-(Cos(q3b)*Cos(q4b)*Sin(q2b)) - Cos(q2b)*Sin(q4b))*Sin(q5b)) -
    ...
    //H34d2
    la_d3rtm(2,3) = a7b*Cos(q7b)*(Cos(q5b)*(-(Cos(q3b)*Sin(q1b)) +
                    Cos(q1b)*Cos(q2b)*Sin(q3b)) -
                 (Cos(q4b)*(Cos(q1b)*Cos(q2b)*Cos(q3b) + Sin(q1b)*Sin(q3b)) -
                    Cos(q1b)*Sin(q2b)*Sin(q4b))*Sin(q5b)) -
              a7b*(Cos(q6b)*(Cos(q5b)*(Cos(q4b)*
...
//Right arm
double sense_vision_u(vector<double> mu, vector<double> a)
{
...
double sense_vision_v(vector<double> mu, vector<double> a)
{
	if (publish){
...
double calc_vision_u(vector<double> mu, vector<double> a)
{
	calc_le_camera_projection(mu, a);
	calc_camera_parameters(cam_projection);	
	
	double vision_u = fx*(xp*ck + px + pxx) + cx;
	
	if (publish){
		Bottle& output_calc_u = plot_calc_u.prepare();
		output_calc_u.clear();
		output_calc_u.addDouble(vision_u);
		plot_calc_u.write();
	}

	calc_vision_pos(0) = vision_u;

	return vision_u;
}

double calc_vision_v(vector<double> mu, vector<double> a)
{
	//calc_le_camera_projection(mu, a);
	//calc_camera_parameters(cam_projection);

	double vision_v = fy*(yp*ck + py + pyy) + cy;
	
	if (publish){
		Bottle& output_calc_v = plot_calc_v.prepare();
		output_calc_v.clear();
		output_calc_v.addDouble(vision_v);
		plot_calc_v.write();
	}

	calc_vision_pos(1) = vision_v;
