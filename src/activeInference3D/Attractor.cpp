...
void calc_3d_jacobian(vector<double> mu, vector<double> a)
{
	...
	ra_3d_jacobian_mu4 = ra_d4rtm * ra_repv;
	...
	ra_3d_jacobian(0,3) = ra_3d_jacobian_mu4(0)/k;
	ra_3d_jacobian(1,3) = ra_3d_jacobian_mu4(1)/k;
	ra_3d_jacobian(2,3) = ra_3d_jacobian_mu4(2)/k;
}
...
void calc_3d_jacobian_origin(vector<double> mu, vector<double> a)
{
	...
	ra_3d_jacobian_mu4_origin = ra_d4rtm * ra_origin;
	...
	ra_3d_jacobian_origin(0,3) = ra_3d_jacobian_mu4_origin(0)/k;
	ra_3d_jacobian_origin(1,3) = ra_3d_jacobian_mu4_origin(1)/k;
	ra_3d_jacobian_origin(2,3) = ra_3d_jacobian_mu4_origin(2)/k;
}
...
{	
    ...
    calc_d_camera_parameters_mu3(le_projection, d3_le_projection);
    ...
    ra_visual_jacobian_head(0,2) = d_vision_u_mu3_head(mu,a);
    ra_visual_jacobian_head(1,2) = d_vision_v_mu3_head(mu,a);
}
...
double calc_attractor_3d_f1(vector<double> mu, vector<double> a)
{
    ...
    ra_3d_f_attr = pseudoinverse(ra_3d_jacobian) * ra_3d_attr;
...
/*	//set end-effector position to origin
    ...
    calc_visual_pos(0) = calc_vision_l_u(mu,a);
    calc_visual_pos(1) = calc_vision_l_v(mu,a);
...
//Stereo vision --------------------------------------------------------------------
//Right arm
void calc_attractor_stereo_vector(vector<double> mu, vector<double> a)
{
    Vector3d calc_3d_pos;
...
/*	//set end-effector position back to marker
    ...
    //build attractor vector //calculated in vision thread
    /*attr_3d_pos(0) = sense_3d_attractor_x(mu,a);
    attr_3d_pos(1) = sense_3d_attractor_y(mu,a);
    attr_3d_pos(2) = sense_3d_attractor_z(mu,a);*/

	//calculate attractor vector
	ra_3d_attr = ro1 * (attr_3d_pos - calc_3d_pos);
}

double calc_attractor_stereo_f1(vector<double> mu, vector<double> a)
{
	double attr_3d_f1;
	
    calc_attractor_stereo_vector(mu, a);
	calc_3d_jacobian(mu, a);
...
double calc_attractor_stereo_f2(vector<double> mu, vector<double> a)
{
	double attr_3d_f2;
...
double calc_attractor_stereo_f3(vector<double> mu, vector<double> a)
{
	double attr_3d_f3;
...
double calc_attractor_stereo_f4(vector<double> mu, vector<double> a)
{
	double attr_3d_f4;
	...
	attr_3d_f4 = ra_3d_f_attr(3);
	
	return attr_3d_f4;
}

//Right arm
void calc_attractor_stereo_vector_b(vector<double> mu, vector<double> a)
{
	Vector3d calc_3d_pos;
    Vector4d attr_3d_pos_calc;
	Vector3d attr_3d_pos;
...
/*	//set end-effector position to origin
	...
	//calculate 3d position
	calc_3d_pos(0) = calc_3d_position_x_b(mu,a);
	calc_3d_pos(1) = calc_3d_position_y_b(mu,a);
	calc_3d_pos(2) = calc_3d_position_z_b(mu,a);
...
/*	//set end-effector position back to marker
	...
	//build attractor position
    attr_3d_pos_calc(0) = att_pos(0);
    attr_3d_pos_calc(1) = att_pos(1);
    attr_3d_pos_calc(2) = att_pos(2);
    attr_3d_pos_calc(3) = 1;
    ...
    attr_3d_pos_calc = le_rtm_inv*attr_3d_pos_calc;
	
    //build attractor vector
    attr_3d_pos(0) = attr_3d_pos_calc(0);
    attr_3d_pos(1) = attr_3d_pos_calc(1);
    attr_3d_pos(2) = attr_3d_pos_calc(2);

	//calculate attractor vector
	la_3d_attr = ro1 * (attr_3d_pos - calc_3d_pos);
}

double calc_attractor_stereo_f1_b(vector<double> mu, vector<double> a)
{
	double attr_3d_f1;
	
    calc_attractor_stereo_vector_b(mu, a);
	calc_3d_jacobian_b(mu, a);
	
    la_3d_f_attr = pseudoinverse(la_3d_jacobian) * la_3d_attr;
	
	attr_3d_f1 = la_3d_f_attr(0);
	
	return attr_3d_f1;
	
}

double calc_attractor_stereo_f2_b(vector<double> mu, vector<double> a)
{
	double attr_3d_f2;
	...
	//ra_3d_f_attr = pseudoinverse(ra_3d_jacobian_b) * la_3d_attr;

	attr_3d_f2 = la_3d_f_attr(1);
	
	return attr_3d_f2;
}

double calc_attractor_stereo_f3_b(vector<double> mu, vector<double> a)
{
	double attr_3d_f3;
	...
	//la_3d_f_attr = pseudoinverse(ra_3d_jacobian_b) * la_3d_attr;

	attr_3d_f3 = la_3d_f_attr(2);
	
	return attr_3d_f3;
}

double calc_attractor_stereo_f4_b(vector<double> mu, vector<double> a)
{
	double attr_3d_f4;
...
void calc_attractor_head_vector(vector<double> mu, vector<double> a)
{
	...
	//build attractor position
    attr_visual_pos(0) = att_pos(3); //u coordinate of left eye
    attr_visual_pos(1) = att_pos(4); //v coordinate of left eye
	
	//calculate visual attractor vector
    //center attractor to left eye visual plane
...
double calc_attractor_head_f1(vector<double> mu, vector<double> a)
{
    ...
    //pseudoinverse
    head_visual_f_attr = pseudoinverse(ra_visual_jacobian_head) * head_visual_attr;
...
double calc_attractor_head_f3(vector<double> mu, vector<double> a)
{
    double attr_head_f3;
    ...
    attr_head_f3 = head_visual_f_attr(2);
