...
extern Vector4d ra_3d_jacobian_mu4; //mu4 part of end effector velocity jacobian
...
extern Vector4d ra_3d_jacobian_mu4_origin; //mu3 part of end effector origin velocity jacobian
...
extern Vector4d la_3d_jacobian_mu4; //mu3 part of end effector velocity jacobian
...
extern Vector4d la_3d_jacobian_mu4_origin; //mu3 part of end effector origin velocity jacobian
...
extern Eigen::Matrix<double, 3, 4> ra_3d_jacobian;  //end effector velocity jacobian
extern Eigen::Matrix<double, 3, 4> ra_3d_jacobian_origin;  //end effector origin velocity jacobian
extern Eigen::Matrix<double, 3, 4> la_3d_jacobian;  //end effector velocity jacobian
extern Eigen::Matrix<double, 3, 4> la_3d_jacobian_origin;  //end effector origin velocity jacobian
extern Eigen::Matrix<double, 3, 4> ra_3d_hessian_mu1;  //velocity hessian for wrt mu1
extern Eigen::Matrix<double, 3, 4> ra_3d_hessian_mu2;  //velocity hessian for wrt mu2
extern Eigen::Matrix<double, 3, 4> ra_3d_hessian_mu3;  //velocity hessian for wrt mu2
extern Eigen::Matrix<double, 3, 4> ra_3d_hessian_mu1_origin;  //velocity origin hessian for wrt mu1
extern Eigen::Matrix<double, 3, 4> ra_3d_hessian_mu2_origin;  //velocity origin hessian for wrt mu2
extern Eigen::Matrix<double, 3, 4> ra_3d_hessian_mu3_origin;  //velocity origin hessian for wrt mu2
extern Vector3d ra_3d_attr; //right arm 3d attractor dynamics vector
extern Vector4d ra_3d_f_attr; //right arm 3d attractor joint vector (4 DOF)
extern Vector3d la_3d_attr; //left arm 3d attractor dynamics vector
extern Vector4d la_3d_f_attr; //left arm 3d attractor joint vector (4 DOF)
...
extern Eigen::Matrix<double, 2, 3> ra_visual_jacobian_head;  //camera visual jacobian
...
extern Vector3d d3_visual_f_attractor; //partial derivative vector for the visual attractor wrt mu3
extern Vector2d head_visual_attr; //head visual attractor position vector
extern Vector3d head_visual_f_attr; //head visual attractor joint vector
